...
func get_description() -> String:
	return "Triggers when a mouse button is pressed."

func get_id() -> String:
	return "on_mouse_button_pressed"

func get_name() -> String:
	return "On Mouse Button Pressed"
...
func get_inputs() -> Array:
	return [
		{"name": "button", "type": "string", "description": "The mouse button to detect: 'left', 'right', 'middle', 'wheel_up', 'wheel_down'."}
	]
...
func poll(node: Node, inputs: Dictionary = {}, block_id: int = -1) -> bool:
	...
	# Trigger only on the frame the button is first pressed
